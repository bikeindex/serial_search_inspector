...
ActiveRecord::Schema.define(version: 20170219185019) do
  ...
  create_table "user_bikes", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["bike_id"], name: "index_user_bikes_on_bike_id", using: :btree
    t.index ["user_id"], name: "index_user_bikes_on_user_id", using: :btree
  end
